...
export default defineSchema({
  ...
  customers: defineTable({
    ...
    createdAt: v.string(),
    updatedAt: v.string(),
  }).index("by_phone", ["phone"]).index("by_name", ["name"]),
  ...
  purchaseOrders: defineTable({
    ...
    subtotal: v.number(),
    status: v.union(v.literal("pending"), v.literal("ordered"), v.literal("received"), v.literal("cancelled"), v.literal("partially-received")),
    notes: v.optional(v.string()),
    createdBy: v.optional(v.id("users")),
    createdAt: v.string(),
    updatedAt: v.string(),
