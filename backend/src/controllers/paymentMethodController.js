...
exports.create = async (req, res) => {
  ...
  try {
    const id = await client.mutation(ref("paymentMethods:create"), { name, description, isActive: isActive !== false })
...
exports.update = async (req, res) => {
  ...
  try {
    const updated = await client.mutation(ref("paymentMethods:update"), { id: req.params.id, name, description, isActive: isActive !== false })
